...
public class ViewReview extends HttpServlet {
    ...
    protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String city = "";
            String ReviewerAge = "";
            String ReviewerGender = "";
            String ReviewerOccupation = "";
            String pin = "";
            ...
            if (hm == null) {
                ...
                if (!hm.containsKey(productName)) {
                    ...
                    for (Review r : hm.get(productName)) {
                        ...
                        pw.print("<tr>");
                        pw.print("<td> reviewerAge: </td>");
                        ReviewerAge = r.getReviewerAge();
                        pw.print("<td>" + ReviewerAge + "</td>");
                        pw.print("</tr>");

                        pw.print("<tr>");
                        pw.print("<td> reviewerGender: </td>");
                        ReviewerGender = r.getReviewerGender();
                        pw.print("<td>" + ReviewerGender + "</td>");
                        pw.print("</tr>");

                        pw.print("<tr>");
                        pw.print("<td> reviewerOccupation: </td>");
                        ReviewerOccupation = r.getReviewerOccupation();
                        pw.print("<td>" + ReviewerOccupation + "</td>");
                        pw.print("</tr>");
