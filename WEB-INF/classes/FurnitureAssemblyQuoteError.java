...
@WebServlet("/FurnitureAssemblyQuoteError")
public class FurnitureAssemblyQuoteError extends HttpServlet
{
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try {
            ...
            + "                <form action='FurnitureAssemblyQuoteSuccess'>"
            + "                    <div class='form-row'>"
            + "                        <div class='form-group col-3'>"
            + "                            <label for='coupon'>Coupon Code (Optional)</label>"
            + "                            <input type='text' class='form-control' placeholder='Coupon Code' value='test'>"
            ...
            + "                            <td>Coupon</td>"
            + "                            <td id='coupon' class='text-right'>- $22.50</td>"
            + "                        </tr>"
