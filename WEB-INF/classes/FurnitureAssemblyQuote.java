...
@WebServlet("/FurnitureAssemblyQuote")
public class FurnitureAssemblyQuote extends HttpServlet
{
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try {
            ...
            + "                <form action='FurnitureAssemblyQuoteError'>"
            + "                    <div class='form-row'>"
            ...
            + "                    <button type='submit' id='buy-button' class='btn text-light'>Validate</button>"
            + "                    <hr>"
            + "                    <h3>Select Worker</h3>"
            + "                    <div class='form-row'>"
